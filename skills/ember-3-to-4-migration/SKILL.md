...
3.28 LTS  →  4.4 LTS  →  4.8 LTS  →  4.12 LTS
                                       ↓
                          (continue with the ember-4-migrator agent)
```
...
When the box is checked, switch to the [`ember-4-to-5-migration`](../ember-4-to-5-migration) skill.

## See also

- `ember-3-octane-adoption` — the prerequisite.
- `ember-4-to-5-migration` — the next hop.
