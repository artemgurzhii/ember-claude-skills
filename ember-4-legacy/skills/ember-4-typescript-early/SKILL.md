...
| Greenfield 4.x app in 2026 | Don't. Use 5.x via the [`ember/`](../../../ember) plugin. |
...
- Modern reference: [`ember/skills/ember-typescript-and-glint`](../../../ember/skills/ember-typescript-and-glint).
