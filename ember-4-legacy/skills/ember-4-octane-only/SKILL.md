...
Identical to the [`ember-octane-fundamentals`](../../../ember/skills/ember-octane-fundamentals) skill in the modern plugin. If you can write modern Octane (native classes, `@tracked`, `@action`, `@service`, modifiers), you can write 4.x.
...
- Modern reference: [`ember/skills/ember-octane-fundamentals`](../../../ember/skills/ember-octane-fundamentals).
