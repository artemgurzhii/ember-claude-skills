...
7. **Hand off to the `ember-3-migrator` agent** once at 3.28.
...
This is **not** a 2.18 → 3.4 task. Plan it for the dedicated Octane adoption phase covered in the [`ember-3-octane-adoption`](../skills/ember-3-octane-adoption) skill.
...
…stop. Hand off to the `ember-3-migrator` agent for the 3 → 4 jump.
